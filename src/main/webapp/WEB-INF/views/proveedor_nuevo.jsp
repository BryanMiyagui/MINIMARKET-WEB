<%-- 
    Document   : proveedor_nuevo
    Created on : 15/01/2020, 10:13:25 AM
    Author     : jbustillos
--%>
  ...
  <body>
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>Registro de Proveedores</h3>
            <div class="form-panel">
                <br>
              <form:form name="" method="post" modelAttribute="proveedor" style="padding: 20px" class="form-horizontal style-form">
             
            <div class="form-group">
            <div class="form-group">
                   <label class="control-label col-md-3">Nombre Empreso:</label>
                   <div class="col-md-3 col-xs-11">
                    <form:input type="text" path="nombre_Empreso" required="" class="form-control" size="20" maxlength="64" /> 
                   </div>
            </div>
            <div class="form-group">
                   <label class="control-label col-md-3">Contacto:</label>
                   <div class="col-md-3 col-xs-11">
                    <form:input type="text" path="contacto" required="" class="form-control" size="20" maxlength="64" /> 
                   </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                   ...
                   <div class="col-md-3 col-xs-11">
                    <form:input type="text" path="nro_Doc" required="" class="form-control" size="20" maxlength="10" /> 
                    </div>
                </div>
                   <br><br> <br><br> <br><br>
            <button type="submit" class="btn btn-success btn-xs">Guardar</button>
            <button type="button" class="btn btn-danger btn-xs" onclick="location.href='<c:url value="/proveedor"/>'">Cancelar</button>            
        </form:form>
        </div>
        </div>
       </section>  
