<%-- 
    Document   : venta
    Created on : 25/01/2020, 12:26:04 PM
    Author     : jbustillos
--%>
          ...
          <div class="col-md-12">
            <div class="content-panel">
              ...
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i>VENTA</h4>
                <hr>
                <td>
                      <button class="btn btn-success btn-xs"><i class="fa fa-check"></i>  <a href="<c:url value='/venta_nuevo'/>">Nuevo</a></button>
                ...
                <tbody>
                    <tr>
                        <c:forEach var="key" items="${lVenta}">
                            <tr>
                                <td>${key.id_venta}</td>                    
                                <td>${key.fecha_venta}</td>
                                <td>${key.cliente.nombre}</td>
                                <td>${key.tipoPago.descripcion}</td>  
                                
                                <td>${key.valor_neto}</td>
                                <td>${key.impuesto}</td>
