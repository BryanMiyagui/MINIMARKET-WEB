<%-- 
    Document   : usuario
    Created on : 05/01/2020, 10:59:23 PM
    Author     : jbustillos
--%>
                    ...
                    <div class="form-panel">
                      <!--<form class="form-horizontal style-form"-->
                        <br>
                            ...
                            <form:form name="" method="post" modelAttribute="userVo" style="padding: 20px" class="form-horizontal style-form">

                                <div class="form-group">
                                    <label class="control-label col-md-3">Usuario:</label>
                                    <div class="col-md-3 col-xs-11">
                                        <form:input type="text" path="username"  required="" class="form-control" size="20" maxlength="16" /> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 col-xs-11">
                                        <form:input type="password" path="password"  required="" class="form-control" size="20" maxlength="60" /> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 col-xs-11">
                                        <form:input type="text" path="apellidos" required="" class="form-control" size="20" maxlength="64" /> 
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">EMail:</label>
                                        <div class="col-md-3 col-xs-11">
                                            <form:input type="text" path="correo" required="" class="form-control" size="20" maxlength="64" /> 
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">Rol(es):</label>
                                    <div class="col-md-3 col-xs-11">
                                        <form:select path="itemsRole" multiple="false" class="form-control"  maxlength="20" 
                                             items="${bRoles}" 
                                             itemValue="id_role" 
                                             itemLabel="type">                
                                        </form:select> 
