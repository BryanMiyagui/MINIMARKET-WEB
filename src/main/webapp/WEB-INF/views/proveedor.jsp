<%-- 
    Document   : proveedor
    Created on : 15/01/2020, 09:19:19 AM
    Author     : jbustillos
--%>
...
<html>
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> MANTENIMIENTO DE PROVEEDORES</h3>
        <div class="row">
            <security:authentication var="username" 
                                 property="principal.username"/>
          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i>PROVEEDOR</h4>
                <hr>
                <td>
                      <button class="btn btn-success btn-xs"><i class="fa fa-check"></i>  <a style="color:white"  href="<c:url value='/proveedor_nuevo'/>">Nuevo</a></button>
                ...
                <tbody>
                  <tr>
                      <c:forEach var="key" items="${lProveedor}">
                <tr>
                    <td>${key.id_proveedor}</td>
                    <td>${key.nombre_Empreso}</td>
                    <td>${key.contacto}</td>                    
                    <td>${key.telefono}</td>
                   ...
                   <td>
                        <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i> 
                            <a style="color:white" href="<c:url value='/proveedor_editar/${key.id_proveedor}'/>">Editar</a></button>
                    </td> 
                          <td> 
                              <button class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> 
                            <a style="color:white" href="<c:url value='/proveedor_eliminar/${key.id_proveedor}'/>">Eliminar</a></button>
                          </td>  
