<%-- 
    ...
    Created on : 15/01/2020, 03:39:21 PM
    Author     : jbustillos
--%>
   ...
   <body>
        ...
        <div class="form-panel-mini">
                ...
                <div class="form-group">
                  <div class="col-md-4">
                    <div class="input-group input-large">
                      ...
                      <form:input type="text"  path="id_proveedor" class="form-control" size="20" maxlength="3" readonly="true" /> 
                    </div>
                  </div>
                </div>
                <hr>
            ...
            <button class="btn btn-primary btn-xs" type="submit"  >Guardar</button>
             <button class="btn btn-danger btn-xs" type="button" onclick="location.href='<c:url value="/proveedor"/>'">Cancelar</button>             
