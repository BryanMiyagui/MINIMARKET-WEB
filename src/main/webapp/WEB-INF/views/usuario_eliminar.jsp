<%-- 
    Document   : usuario_eliminar
    Created on : 06/01/2020, 09:53:57 PM
    Author     : jbustillos
--%>
...
<html>
    ...
    <body>
      ...
      <section class="wrapper">
        <h3><i class="fa fa-angle-right-min"></i>ELIMINAR USUARIO</h3>
        
        <div class="form-panel-mini">
        
            
            <form:form name="" method="post" modelAttribute="userVo" style="padding: 20px">
            ...
            <div class="form-group">
                <div class="col-md-4">
                    ...
                    <form:input type="text" path="id_user"  placeholder="Ingrese Codigo" class="form-control" size="20" maxlength="3" readonly="true"/> 
            ...
            <div class="form-group">
                <div class="col-md-4">
                    ...
                    <form:input type="text" path="username"  placeholder="Ingrese UserName" class="form-control" size="20" maxlength="16" /> 
            ...
            <div class="form-group">
                <div class="col-md-4">
                    ...
                    <form:input type="password" path="password" placeholder="Ingrese UserName" class="form-control" size="20" maxlength="20" /> 
            ...
            <div class="form-group">
                <div class="col-md-4">
                    ...
                    <form:input type="text" path="correo" class="form-control" size="20" maxlength="64" /> 
            ...
            <div class="col-md-4">
                <div class="input-group input-large">
                    ...
                    <form:input type="text" path="telefono" class="form-control" size="20" maxlength="9" /> 
                    <form:errors path="telefono" cssClass="error"/>
                </div>
            </div>
            </div> 
            ...
            <button class="btn btn-primary btn-xs" type="button" onclick="location.href='<c:url value="/usuario"/>'">Cancelar</button>             
