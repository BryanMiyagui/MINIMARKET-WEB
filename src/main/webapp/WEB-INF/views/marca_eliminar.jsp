<%-- 
    Document   : marca_eliminar
    Created on : 05/01/2020, 10:32:01 PM
    Author     : jbustillos
--%>
  ...
  <head>
    ...
    <body>
        ...
        <section class="wrapper">
            <h3><i class="fa fa-angle-right-min"></i>ELIMINAR MARCA</h3>
        
        <div class="form-panel-mini">
        
            
            <form:form name="" method="post" modelAttribute="marca" style="padding: 50px" >
            
            <div class="form-group">
                  <div class="col-md-4">
                    <div class="input-group input-large">
                      <label class="control-label col-md-4">Codigo:</label>
                      <form:input type="text"  path="id_marca" class="form-control" size="20" maxlength="2" readonly="true"/> 
            ...
            <button type="button" class="btn btn-primary btn-xs" onclick="location.href='<c:url value="/marca"/>'">Cancelar</button>             
