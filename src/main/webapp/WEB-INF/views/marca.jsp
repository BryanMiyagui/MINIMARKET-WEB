<%-- 
    Document   : marca
    Created on : 05/01/2020, 10:27:24 PM
    Author     : jbustillos
--%>
          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i>MARCAS</h4>
                <hr>
                <td>
                      <button class="btn btn-success btn-xs"><i class="fa fa-check"></i>  <a style="color:white" href="<c:url value='/marca_nuevo'/>">Nuevo</a></button>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i> 
                            <a style="color:white" href="<c:url value='/marca_editar/${key.id_marca}'/>">Editar</a></button>
                    </td>
                          
                          <td> 
                              <button class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> 
                            <a style="color:white" href="<c:url value='/marca_eliminar/${key.id_marca}'/>">Eliminar</a></button>
                          </td>  
