<%-- 
    Document   : categoria_nuevo
    Created on : 05/01/2020, 10:34:06 PM
    Author     : jbustillos
--%>
...
<html>
  <head>
        ...
        <title>Registrar nuevo Categoria</title>
    ...
    <body>
        ...
        <section id="main-content">
            <section class="wrapper">
                <h3><i class="fa fa-angle-right"></i>Registro Categoria</h3>
                    <div class="form-panel">
                      <!--<form class="form-horizontal style-form"-->
                        <br>
                            <form:form name="" method="post" modelAttribute="categoria" style="padding: 20px" class="form-horizontal style-form">
