<%-- 
    Document   : categoria_eliminar
    Created on : 05/01/2020, 10:36:41 PM
    Author     : jbustillos
--%>
    ...
    <body>
      <header class="header black-bg">
        ...
        <div class="form-panel-mini">
            ...
            <div class="form-group">
                  <div class="col-md-4">
                    <div class="input-group input-large">
                      ...
                      <form:input type="text"  path="id_categoria" class="form-control" size="20" maxlength="16" readonly="true"/> 
                    </div>
                  </div>
            </div>
            <hr>
            ...
            <button type="button" class="btn btn-primary btn-xs" onclick="location.href='<c:url value="/categoria"/>'">Cancelar</button>                        
        </form:form>
            </div>
