<%-- 
    Document   : tipoDocumento_eliminar
    Created on : 12/01/2020, 06:35:07 PM
    Author     : jbustillos
--%>
  ...
  <head>
    ...
    <body>
        ...
        <div class="form-panel-mini">
            <form:form name="" method="post" modelAttribute="tipoDocumento" style="padding: 50px" >
            
            <div class="form-group">
                  <div class="col-md-4">
                    <div class="input-group input-large">
                      <label class="control-label col-md-4">Codigo:</label>
                        <form:input type="text"  path="id_TipoDoc" class="form-control" size="20" maxlength="3" /> 
                    </div>
                  </div>
            </div>
             <hr>
            ...
            <button type="button" class="btn btn-primary btn-xs" onclick="location.href='<c:url value="/tipoDocumento"/>'">Cancelar</button>             
