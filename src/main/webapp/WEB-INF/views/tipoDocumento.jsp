<%-- 
    ...
    Created on : 12/01/2020, 05:35:58 PM
    Author     : jbustillos
--%>
...
<html>
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> MANTENIMIENTO DE TIPO DE DOCUMENTO</h3>
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i>TIPO DE DOCUMENTO</h4>
                <hr>
                <td>
                      <button class="btn btn-success btn-xs"><i class="fa fa-check"></i>  <a style="color:white" href="<c:url value='/tipoDocumento_nuevo'/>">Nuevo</a></button>
                ...
                <tbody>
                  <tr>
                      <c:forEach var="key" items="${LtipoDocumento}">
                <tr>
                    <td>${key.id_TipoDoc}</td>                    
                    <td>${key.descripcion}</td>
                    <td>${key.estado}</td>
                    <td>
                        <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i> 
                            <a style="color:white" href="<c:url value='/tipoDocumento_editar/${key.id_TipoDoc}'/>">Editar</a></button>
                    </td>
                    <td> 
                        <button class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> 
                      <a style="color:white" href="<c:url value='/tipoDocumento_eliminar/${key.id_TipoDoc}'/>">Eliminar</a></button>
                    </td>  
                </tr>
                      </c:forEach>   
                  </tr>
